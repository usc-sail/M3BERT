    ...
    with torch.no_grad():
        ...
        if length_routine == 'CONSTANT':
            for idx in range(len(spec_stacked)):
                ...
                #ssssssss
                #CONSTANT TODO this should be 272!
                #CAn be 40
                ...
                #CONSTANT TODO THIS SHOULD BE 52 + term!
                ...
                #CONSTANT TODO DO THE SAME HERE UNCOMMENT!
                mask_label[idx][:,52+chosen_index_feat:52+chosen_index_feat+chosen_index_feat2]=1
                #mask_label[idx][:,chosen_index_feat:chosen_index_feat+chosen_index_feat2]=1
